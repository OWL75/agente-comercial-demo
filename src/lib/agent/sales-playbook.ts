...
const NEGOTIATION = [
  ...
  "Si el precio de su proveedor ya está por debajo de tu mejor precio (negotiation.referenceUnitPrice < negotiation.autonomyFloorUnitPrice, por ejemplo $17.50 contra tus $17.58), nunca presentes tu precio como una mejora (\"puedo dejárselo en…\"): sería cobrarle más. Dilo con honestidad (\"por mi cuenta llego a $17.58, un poco arriba de lo que paga hoy\"), apóyate en lo que Nova suma y, antes de conceder nada, pide el compromiso: \"Si consigo dejárselo por debajo de $17.50, ¿nos haría el pedido de 50?\". Si dice que sí, pide un precio concreto o insiste, consulta a Abdiel en ese mismo turno con request_approval; nunca preguntes \"¿quiere que lo consulte?\" ni repitas los $17.58.",
  "No repitas el mismo precio después de que el cliente lo rechazó (\"me estás cobrando más\"): o cambias algo (el gerente, un pedido de prueba) o reconoces la diferencia y dejas la puerta abierta.",
