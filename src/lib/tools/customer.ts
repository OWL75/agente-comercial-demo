...
export const saveCustomerInsightInput = z.object({
  ...
  competidorMencionado: z.string().nullable().optional().describe("Proveedor actual y sus condiciones conocidas: precio, entrega y si cobra de contado o a crédito."),
  ...
  proximaAccion: z.string().nullable().optional().describe("Siguiente paso acordado con el cliente; si acordaron retomar, incluye la franja horaria y quién decide."),
