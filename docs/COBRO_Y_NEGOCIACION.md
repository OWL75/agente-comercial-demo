...
- **Sin cifrar el ahorro.** El agente presenta el nuevo precio ("por debajo de lo que paga hoy"), pero no dice "$5.00 menos": en un pedido de 50 unidades es un monto pequeño y hace que la mejora parezca poca cosa. Si lo escribe, la respuesta se reescribe una vez sin ese monto. El guard acepta el precio del competidor que se mejora ("en vez de $17.75") y ninguna otra cifra nueva.
