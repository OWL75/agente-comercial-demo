...
1. Cuando **las 7 plantillas** estén aprobadas, despliega la rama `plantillas-meta` en EasyPanel.
2. Añade la variable `WHATSAPP_TEMPLATES_ENABLED=true` y vuelve a desplegar.
3. Mientras esa variable no sea `true`, la app se comporta como antes y no usa plantillas.
