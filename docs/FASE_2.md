...
Estado: bloque 1 desplegado en un servicio paralelo de EasyPanel. La migración de guardas de base de datos fue aplicada y verificada en Supabase productivo el 22 de septiembre de 2026. La versión 2.1 añade preparación repetible para demostraciones y queda pendiente de desplegar sobre ese servicio.
...
Resultado local de la versión 2.1: **101 pruebas pasando** antes del build final, TypeScript y ESLint correctos. Esto no certifica producción ni sustituye la validación de staging.
